...
// TODO: Work on the testing/ Status: Not working as planned.
...
describe('Form', () => {
    ...
    test('selects state', () => {
        ...
        fireEvent.change(stateSelect, { target: { value: { name: "New York", abbreviation: "NY" } } })

        // assert the selected value is "New York"
        expect(stateSelect.value).toBe({ name: "New York", abbreviation: "NY" })
    })
