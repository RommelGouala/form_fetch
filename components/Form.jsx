               ...
               {/*if the posted is false it will display the form but as soon as it becomes true it will display the h2. At the place of the h2 I can add a component. the component will show success */}
                ...
                <form onSubmit={handleSubmit} data-testid="Form">
                    ...
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                        ...
                        <input data-testid="InputForName" onChange={handleChange} className="pl-2 outline-none border-none bg-transparent text-black" type="text" name="name" value={data.name} placeholder="Full name" maxLength="50" minLength='3' aria-required="true" required />
                    </div>
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                        ...
                        <input data-testid="InputForEmail" onChange={handleChange} className="pl-2 outline-none border-none bg-transparent text-black" type="email" name="email" value={data.email} placeholder="Email Address" maxLength="50" minLength='3' aria-required="true" required />
                    </div>
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-black" viewBox="0 0 20 20"
                            fill="currentColor">
                        ...
                        <input data-testid="InputForPassword" onChange={handleChange} className="pl-2 outline-none border-none bg-transparent text-black" type="password" name="password" value={data.password} placeholder="Password" maxLength="50" minLength='3' aria-required="true" required />
                    </div>
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-black" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <select data-testid="occupation-options" onChange={handleChange} className="pl-2 outline-none border-none bg-transparent text-black" type="text" name="occupation" value={data.occupation} placeholder="Occupation" maxLength="50" minLength='3' aria-required="true" required>
                    ...
                    <div className="flex items-center border-2 py-2 px-3 rounded-2xl mb-4 border-black">
                        ...
                        <select data-testid="state-option" onChange={handleChange} className="pl-2 outline-none border-none bg-transparent text-black" type="text" name="state" value={data.state[0]} placeholder="State" maxLength="50" minLength='3' aria-required="true" required>
                            <option data-testid="OptionForState"  defaultValue>Choose a State</option>
                            {theStates}
                        </select>
                    </div>
                    <button data-testid="SubmitFormButton" aria-label="Sumbit button" type="submit" className=" block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2">Submit</button>
                </form>
                : <h2 data-testid="SuccessMessage">Thanks for your Submittion</h2>
                }
